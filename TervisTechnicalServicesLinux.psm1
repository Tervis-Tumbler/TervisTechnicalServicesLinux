...
function Invoke-OraDBARMTDktProvision {
    ...
    foreach ($Node in $Nodes) {
        ...
        Invoke-Command -ComputerName $Node.ComputerName -ScriptBlock {Copy-Item -Path "\\fs1\disasterrecovery\Programs\Oracle\Oracle SQL Developer\sqldeveloper-4.2.0.17.089.1709-x64\Oracle SQL Developer" -Destination "c:\Program Files\Oracle SQL Developer"}
